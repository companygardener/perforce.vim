...
augroup perforce
  ...
  map <silent> <Leader>4y :echo <SID>P4SyncFile()<CR>
  map <silent> <Leader>4d :echo <SID>P4DiffFile()<CR>
  map <silent> <Leader>4u :echo <SID>P4UDiffFile()<CR>
  map <silent> <Leader>4z :echo <SID>P4VDiffFile()<CR>
  map <silent> <Leader>4v :echo <SID>P4VersionsFile()<CR>
  map <silent> <Leader>4p :echo <SID>P4PrintFile()<CR>
  map <silent> <Leader>4h :echo <SID>P4Help()<CR>
  map <silent> <Leader>4l :call <SID>P4Login()<CR>
  map <silent> <Leader>4x :call <SID>P4OpenFileForDeletion()<CR>
  map <silent> <Leader>4C :call <SID>P4CreateChangelist()<CR>
  map <silent> <Leader>4D :echo <SID>P4DiffFiles()<CR>
  map <silent> <Leader>4U :echo <SID>P4UDiffFiles()<CR>
  map <silent> <Leader>4L :echo <SID>P4GetChangelists(1)<CR>
  map <silent> <Leader>4I :echo <SID>P4GetChangelistInfo()<CR>
  map <silent> <Leader>4F :echo <SID>P4GetFiles()<CR>
  map <silent> <Leader>4X :call <SID>P4DeleteChangelist()<CR>
  map <silent> <Leader>4S :call <SID>P4SubmitChangelist()<CR>
